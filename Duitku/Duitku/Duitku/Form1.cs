        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if(result ==1) //login success
                {
                    ...
                    NpgsqlCommand cmd_id = new NpgsqlCommand("Select id from pengguna where user_email = '" + tbEmail.Text + "' and password = '" + tbPassword.Text + "'", conn);
                    ...
                    NpgsqlCommand cmd_name = new NpgsqlCommand("Select user_name from pengguna where user_email = '" + tbEmail.Text + "' and password = '" + tbPassword.Text + "'", conn);
